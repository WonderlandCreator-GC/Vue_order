...
export const INCRE_COUNT = 'incre_count' // 增加food中的count
export const DECRE_COUNT = 'decre_count' // 减少food中的count

export const CLEAR_CART = 'clear_cart' // 清空购物车

export const RECEIVE_Search_Shops = 'recive_search_shops' // 接收被搜索的商家列表
